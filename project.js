...
function showSlides(n) {
  let i;
  let slides = document.getElementsByClassName("roll");
...
$(document).ready(function() {
	...
	$("#thanksMessage, #checkOrderJollof, #checkOrderZaafi, #checkOrderFufu, #checkOrderBanku, #checkOrderWaakye, #checkOrderRedRed,#checkOrderAmpesi, #finishOrderDialog").hide();
